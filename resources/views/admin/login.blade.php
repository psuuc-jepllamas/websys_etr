...
<head>
    ...
    <title>Login - PSU Admin Dashboard</title>
    ...
    <div class="d-flex flex-column min-vh-100">
        <header class="header">
            <div class="container d-flex align-items-center">
                ...
                <h2 class="mb-0">Pangasinan State University - Admin Login</h2>
            </div>
        </header>

        <div class="main-content">
            <h1 class="text-center mb-4" style="color: #003087;">Login</h1>
            @if ($errors->any())
            ...
            <p class="text-center mt-3">
                Don't have an account? <a href="{{ route('register') }}" style="color: #003087;">Register</a>
            </p>
        </div>
