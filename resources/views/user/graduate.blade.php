...
<head>
    ...
    <title>Graduate - Transfer Credentials System</title>
    <!-- Bootstrap CSS -->
    ...
    <main class="main">
        <div class="login-container">
            ...
            <div class="login-right">
                ...
                @endif
                <form method="POST" action="{{ route('user.graduate.store') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="course">Program Graduated (Select below)</label>
